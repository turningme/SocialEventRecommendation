 ...
 * @author jpliu
 */
public class UserProfileInputFormatV2 extends FileInputFormat<LongWritable, UserProfile> {
    @Override
    public RecordReader<LongWritable, UserProfile> getRecordReader(InputSplit inputSplit, JobConf jobConf, Reporter reporter) throws IOException {
        return new UserProfileRecordReaderV2(jobConf,(FileSplit)inputSplit);
    }
}
