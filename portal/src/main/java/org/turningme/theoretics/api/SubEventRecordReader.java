            ...
            if (line.contains("<clusterid>")) {
                ...
                if (success){
                    if (line.contains("<msgcontfidf>")) {
                        ...
                        String[] values = line.substring(line.indexOf("<msgcontfidf>") + 14, line.indexOf("</msgcontfidf>")).trim().split("\t");
                        ...
                        if (success){
                            ...
                            if (line.contains("<SpaceRange>")) {
                                ...
                                String[] valuess = line.substring(line.indexOf("<SpaceRange>") + 13, line.indexOf("</SpaceRange>")).trim().split("\t");
                                ...
                                if (success) {
                                    ...
                                    if (line.contains("<TimeRange>")) {
                                        String[] value2 = line.substring(line.indexOf("<TimeRange>") + 12, line.indexOf("</TimeRange>")).trim().split("\t");
                                                    ...
                                                    if (line.contains("<TimeRangeSet>")) {
                                                        ...
                                                        if (success) {
                                                            ...
                                                            if (line.contains("<useridlist>")) {
                                                                ...
                                                                String[] value3 = line.substring(line.indexOf("<useridlist>") + 13, line.indexOf("</useridlist>")).trim().split("\t");
